...
description: >
  Transforms research findings into executive-ready briefings.
  Automatically activated when user mentions executive, briefing, C-suite,
  board, leadership, or presentation.
